...
// Низкоуровневая функция для записи одной пары "ключ-значение" в реестр
{
...
// Регистрирует один COM-класс на основе информации из CLASS_INFO
{
...
// Удаляет регистрацию одного COM-класса
{
