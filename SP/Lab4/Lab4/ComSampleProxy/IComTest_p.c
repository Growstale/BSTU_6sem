...
extern const MIDL_SERVER_INFO IVAVTest_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IVAVTest_ProxyInfo;
...
/* 34 */	0x8,		/* FC_LONG */
	...
	/* Procedure CalculateSumOfDigits */
...
/* Object interface: IComTest, ver. 0.0,
   GUID={0xdb24e16f,0xaa47,0x4fae,{0x83,0xbb,0x9f,0x18,0xeb,0xd1,0xe9,0xbc}} */
...
/* Object interface: IVAVTest, ver. 0.0,
   GUID={0x704e2ec6,0xa123,0x4631,{0xb2,0xa7,0x6a,0xfb,0x30,0xd4,0x3a,0x45}} */

#pragma code_seg(".orpc")
static const unsigned short IVAVTest_FormatStringOffsetTable[] =
    {
    36
    };

static const MIDL_STUBLESS_PROXY_INFO IVAVTest_ProxyInfo =
    {
    &Object_StubDesc,
    IComTest__MIDL_ProcFormatString.Format,
    &IVAVTest_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IVAVTest_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    IComTest__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _IVAVTestProxyVtbl = 
{
    &IVAVTest_ProxyInfo,
    &IID_IVAVTest,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IVAVTest::CalculateSumOfDigits */
};

const CInterfaceStubVtbl _IVAVTestStubVtbl =
{
    &IID_IVAVTest,
    &IVAVTest_ServerInfo,
    4,
...
const CInterfaceProxyVtbl * const _IComTest_ProxyVtblList[] = 
{
    ...
    ( CInterfaceProxyVtbl *) &_IVAVTestProxyVtbl,
    0
};
...
const CInterfaceStubVtbl * const _IComTest_StubVtblList[] = 
{
    ...
    ( CInterfaceStubVtbl *) &_IVAVTestStubVtbl,
    0
};
