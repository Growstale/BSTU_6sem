...
spool "MIGRATION_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_MIGRATION ...
DROP ROLE ROLE_MIGRATION ;
PROMPT Creating Role ROLE_MIGRATION ...
CREATE ROLE ROLE_MIGRATION ;
...
GRANT ALL ON utils TO ROLE_MIGRATION;
...
GRANT ALL ON Employee TO ROLE_MIGRATION;
...
GRANT ALL ON BusinessTrip TO ROLE_MIGRATION;
...
GRANT ALL ON Education TO ROLE_MIGRATION;
...
GRANT ALL ON Position TO ROLE_MIGRATION;
...
GRANT ALL ON Department TO ROLE_MIGRATION;
...
GRANT ALL ON VacationType TO ROLE_MIGRATION;
...
GRANT ALL ON Vacation TO ROLE_MIGRATION;
...
GRANT ALL ON EmployeePosition TO ROLE_MIGRATION;
...
GRANT ALL ON EmployeeFullInfo TO ROLE_MIGRATION;
...
GRANT ALL ON EmployeeBusinessTrips TO ROLE_MIGRATION;
...
GRANT ALL ON EmployeeEducationHistory TO ROLE_MIGRATION;
...
GRANT ALL ON EmployeeVacationInfo TO ROLE_MIGRATION;
...
END;
/
GRANT ALL ON CalculateTotalBonus TO ROLE_MIGRATION;
...
END;
/
GRANT ALL ON AddSubordinate TO ROLE_MIGRATION;
...
END;
/
GRANT ALL ON GetEmployeeHierarchy TO ROLE_MIGRATION;
...
END;
/
GRANT ALL ON GetSubordinatesByEmployeeID TO ROLE_MIGRATION;
...
END;
/
GRANT ALL ON MoveSubtree TO ROLE_MIGRATION;
...
END;
/
GRANT ALL ON ShowSubordinates TO ROLE_MIGRATION;
...
END;
/
GRANT ALL ON UpdateEmployeePosition TO ROLE_MIGRATION;
