...
spool "HR_MIG_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_HR_MIG ...
DROP ROLE ROLE_HR_MIG ;
PROMPT Creating Role ROLE_HR_MIG ...
CREATE ROLE ROLE_HR_MIG ;

-- PROMPT Drop CourseWork user
-- drop user CourseWork cascade;
   
PROMPT Create user CourseWork
CREATE USER CourseWork IDENTIFIED BY &&CourseWork_password PASSWORD EXPIRE ACCOUNT LOCK /* DEFAULT TABLESPACE USERS  TEMPORARY TABLESPACE TEMP */;
GRANT CREATE SESSION, RESOURCE, CREATE VIEW, CREATE MATERIALIZED VIEW, CREATE SYNONYM, UNLIMITED TABLESPACE TO CourseWork;
...
GRANT ALL ON utils TO ROLE_HR_MIG;
grant ALL on utils to CourseWork with grant option;

set define on
prompt connecting to CourseWork
alter session set current_schema=CourseWork;
set define off
DROP TABLE EventsSchedule CASCADE CONSTRAINTS;


PROMPT Creating Table EventsSchedule ...
CREATE TABLE EventsSchedule (
  EventScheduleID NUMBER(10,0) NOT NULL,
...
PROMPT Creating Primary Key Constraint PK__EventsSc__6118F27F36D71FB8 on table EventsSchedule ... 
ALTER TABLE EventsSchedule
ADD CONSTRAINT PK__EventsSc__6118F27F36D71FB8 PRIMARY KEY
(
  EventScheduleID
)
ENABLE
...
GRANT ALL ON EventsSchedule TO ROLE_HR_MIG;
DROP TABLE SectorRows CASCADE CONSTRAINTS;


PROMPT Creating Table SectorRows ...
CREATE TABLE SectorRows (
  SectorRowID NUMBER(10,0) NOT NULL,
  SectorRow NUMBER(10,0) NOT NULL,
  NumberOfSeats NUMBER(10,0) NOT NULL,
  LocationID NUMBER(10,0) NOT NULL,
  CostFactor NUMBER(18,2) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__SectorRo__938B9181C10E8541 on table SectorRows ... 
ALTER TABLE SectorRows
ADD CONSTRAINT PK__SectorRo__938B9181C10E8541 PRIMARY KEY
(
  SectorRowID
)
ENABLE
...
GRANT ALL ON SectorRows TO ROLE_HR_MIG;
DROP TABLE OrganizerQuestions CASCADE CONSTRAINTS;


PROMPT Creating Table OrganizerQuestions ...
CREATE TABLE OrganizerQuestions (
  QuestionID NUMBER(10,0) NOT NULL,
  OrganizerID NUMBER(10,0) NOT NULL,
  QuestionText NVARCHAR2(500) NOT NULL,
  QuestionDate VARCHAR2(200 CHAR) NOT NULL,
...
PROMPT Creating Primary Key Constraint PK__Organize__0DC06F8CDABC18DE on table OrganizerQuestions ... 
ALTER TABLE OrganizerQuestions
ADD CONSTRAINT PK__Organize__0DC06F8CDABC18DE PRIMARY KEY
(
  QuestionID
)
ENABLE
...
GRANT ALL ON OrganizerQuestions TO ROLE_HR_MIG;
...
CREATE TABLE Sales (
  ...
  TicketID NUMBER(10,0) NOT NULL,
  SaleDate VARCHAR2(200 CHAR) NOT NULL,
  Status NVARCHAR2(50) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Sales__1EE3C41FC83BC67D on table Sales ... 
ALTER TABLE Sales
ADD CONSTRAINT PK__Sales__1EE3C41FC83BC67D PRIMARY KEY
(
  SaleID
)
ENABLE
...
GRANT ALL ON Sales TO ROLE_HR_MIG;
DROP TABLE ShoppingCart CASCADE CONSTRAINTS;


PROMPT Creating Table ShoppingCart ...
CREATE TABLE ShoppingCart (
  ShoppingCartID NUMBER(10,0) NOT NULL,
  UserID NUMBER(10,0) NOT NULL,
  TicketID NUMBER(10,0) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Shopping__7A789A8430E50396 on table ShoppingCart ... 
ALTER TABLE ShoppingCart
ADD CONSTRAINT PK__Shopping__7A789A8430E50396 PRIMARY KEY
(
  ShoppingCartID
)
ENABLE
...
GRANT ALL ON ShoppingCart TO ROLE_HR_MIG;
DROP TABLE TicketRefund CASCADE CONSTRAINTS;


PROMPT Creating Table TicketRefund ...
CREATE TABLE TicketRefund (
  TicketRefundID NUMBER(10,0) NOT NULL,
  SaleID NUMBER(10,0) NOT NULL,
  UserID NUMBER(10,0) NOT NULL,
  RefundDate VARCHAR2(200 CHAR) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__TicketRe__2384B71A50411F2E on table TicketRefund ... 
ALTER TABLE TicketRefund
ADD CONSTRAINT PK__TicketRe__2384B71A50411F2E PRIMARY KEY
(
  TicketRefundID
)
ENABLE
...
GRANT ALL ON TicketRefund TO ROLE_HR_MIG;
DROP TABLE UserQuestions CASCADE CONSTRAINTS;


PROMPT Creating Table UserQuestions ...
...
PROMPT Creating Primary Key Constraint PK__UserQues__0DC06F8CB3C707FF on table UserQuestions ... 
ALTER TABLE UserQuestions
ADD CONSTRAINT PK__UserQues__0DC06F8CB3C707FF PRIMARY KEY
(
  QuestionID
)
ENABLE
...
GRANT ALL ON UserQuestions TO ROLE_HR_MIG;
...
CREATE TABLE Comments (
  ...
  CommentDate VARCHAR2(200 CHAR) NOT NULL,
  FivePointRating NUMBER(10,0) NOT NULL,
  Login NCHAR(50)
);


PROMPT Creating Primary Key Constraint PK__Comments__C3B4DFAAD653034C on table Comments ... 
ALTER TABLE Comments
ADD CONSTRAINT PK__Comments__C3B4DFAAD653034C PRIMARY KEY
(
  CommentID
)
ENABLE
;
PROMPT Creating Check Constraint CK__Comments__FivePo__336AA144 on table Comments... 
ALTER TABLE Comments
ADD CONSTRAINT CK__Comments__FivePo__336AA144 CHECK 
(
   ( FivePointRating = (5)
                  OR FivePointRating = (4)
                  OR FivePointRating = (3)
                  OR FivePointRating = (2)
                  OR FivePointRating = (1)
                  OR FivePointRating = (0) )
) 
ENABLE
;

GRANT ALL ON Comments TO ROLE_HR_MIG;
...
PROMPT Creating Primary Key Constraint PK__Users__1788CCAC7B7DFFBE on table Users ... 
ALTER TABLE Users
ADD CONSTRAINT PK__Users__1788CCAC7B7DFFBE PRIMARY KEY
(
  UserID
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Users__5C7E359E9B8DB2AE on table Users
ALTER TABLE Users
ADD CONSTRAINT UQ__Users__5C7E359E9B8DB2AE UNIQUE (
  Phone
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Users__A9D10534CCDD7A1B on table Users
ALTER TABLE Users
ADD CONSTRAINT UQ__Users__A9D10534CCDD7A1B UNIQUE (
  Email
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Users__5E55825B8D7E37B3 on table Users
ALTER TABLE Users
ADD CONSTRAINT UQ__Users__5E55825B8D7E37B3 UNIQUE (
  Login
)
ENABLE
;

GRANT ALL ON Users TO ROLE_HR_MIG;
DROP TABLE Managers CASCADE CONSTRAINTS;


PROMPT Creating Table Managers ...
CREATE TABLE Managers (
  ...
  Email NVARCHAR2(50) NOT NULL,
  Phone NVARCHAR2(30) NOT NULL,
  DateOfEmployment VARCHAR2(200 CHAR) NOT NULL,
  Password NVARCHAR2(100) NOT NULL,
  RoleID NUMBER(10,0) NOT NULL,
  Login NVARCHAR2(40) NOT NULL
);
...
PROMPT Creating Primary Key Constraint PK__Managers__3BA2AA813EF1D9BF on table Managers ... 
ALTER TABLE Managers
ADD CONSTRAINT PK__Managers__3BA2AA813EF1D9BF PRIMARY KEY
(
  ManagerID
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Managers__5E55825B0D50B80E on table Managers
ALTER TABLE Managers
ADD CONSTRAINT UQ__Managers__5E55825B0D50B80E UNIQUE (
  Login
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Managers__5C7E359E513B797A on table Managers
ALTER TABLE Managers
ADD CONSTRAINT UQ__Managers__5C7E359E513B797A UNIQUE (
  Phone
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Managers__A9D10534E156D052 on table Managers
ALTER TABLE Managers
ADD CONSTRAINT UQ__Managers__A9D10534E156D052 UNIQUE (
  Email
)
ENABLE
;

GRANT ALL ON Managers TO ROLE_HR_MIG;
...
PROMPT Creating Primary Key Constraint PK__Roles__8AFACE3AA62C2B9F on table Roles ... 
ALTER TABLE Roles
ADD CONSTRAINT PK__Roles__8AFACE3AA62C2B9F PRIMARY KEY
(
  RoleID
)
ENABLE
;
PROMPT Creating Check Constraint CK__Roles__RoleName__662B2B3B on table Roles... 
ALTER TABLE Roles
ADD CONSTRAINT CK__Roles__RoleName__662B2B3B CHECK 
(
   ( RoleName = 'Organizer'
                  OR RoleName = 'Manager'
                  OR RoleName = 'User' )
...
GRANT ALL ON Roles TO ROLE_HR_MIG;
DROP TABLE Organizers CASCADE CONSTRAINTS;


PROMPT Creating Table Organizers ...
...
PROMPT Creating Primary Key Constraint PK__Organize__AD7DAD22B1785FD6 on table Organizers ... 
ALTER TABLE Organizers
ADD CONSTRAINT PK__Organize__AD7DAD22B1785FD6 PRIMARY KEY
(
  OrganizerID
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Organize__5C7E359E85D66BFB on table Organizers
ALTER TABLE Organizers
ADD CONSTRAINT UQ__Organize__5C7E359E85D66BFB UNIQUE (
  Phone
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Organize__A9D10534B2334A21 on table Organizers
ALTER TABLE Organizers
ADD CONSTRAINT UQ__Organize__A9D10534B2334A21 UNIQUE (
  Email
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Organize__9BCE05DC9A38C406 on table Organizers
ALTER TABLE Organizers
ADD CONSTRAINT UQ__Organize__9BCE05DC9A38C406 UNIQUE (
  CompanyName
)
ENABLE
;

GRANT ALL ON Organizers TO ROLE_HR_MIG;
...
CREATE TABLE Categories (
  ...
  CategoryName NVARCHAR2(40) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Categori__19093A2BCC14B72D on table Categories ... 
ALTER TABLE Categories
ADD CONSTRAINT PK__Categori__19093A2BCC14B72D PRIMARY KEY
(
  CategoryID
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Categori__8517B2E055FD02D0 on table Categories
ALTER TABLE Categories
ADD CONSTRAINT UQ__Categori__8517B2E055FD02D0 UNIQUE (
  CategoryName
)
ENABLE
;

GRANT ALL ON Categories TO ROLE_HR_MIG;
...
CREATE TABLE Tickets (
  ...
  Status NVARCHAR2(50) NOT NULL,
  SectorRowID NUMBER(10,0) NOT NULL,
  PlaceInRow NUMBER(10,0) NOT NULL,
  Price NUMBER(18,2) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Tickets__712CC6279C1FFC1A on table Tickets ... 
ALTER TABLE Tickets
ADD CONSTRAINT PK__Tickets__712CC6279C1FFC1A PRIMARY KEY
(
  TicketID
)
ENABLE
...
GRANT ALL ON Tickets TO ROLE_HR_MIG;
...
CREATE TABLE Locations (
  LocationID NUMBER(10,0) NOT NULL,
  LocationName NVARCHAR2(60) NOT NULL,
  NumberOfSectors NUMBER(10,0) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Location__E7FEA4775483B599 on table Locations ... 
ALTER TABLE Locations
ADD CONSTRAINT PK__Location__E7FEA4775483B599 PRIMARY KEY
(
  LocationID
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Location__F946BB84D9AD3FEF on table Locations
ALTER TABLE Locations
ADD CONSTRAINT UQ__Location__F946BB84D9AD3FEF UNIQUE (
  LocationName
)
ENABLE
;

GRANT ALL ON Locations TO ROLE_HR_MIG;
...
CREATE TABLE Events (
  ...
  EventDuration VARCHAR2(200 CHAR) NOT NULL,
  CategoryID NUMBER(10,0) NOT NULL,
  OrganizerID NUMBER(10,0) NOT NULL,
...
PROMPT Creating Primary Key Constraint PK__Events__7944C87086CCB4CC on table Events ... 
ALTER TABLE Events
ADD CONSTRAINT PK__Events__7944C87086CCB4CC PRIMARY KEY
(
  EventID
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Events__59D2B726804ED70A on table Events
ALTER TABLE Events
ADD CONSTRAINT UQ__Events__59D2B726804ED70A UNIQUE (
  EventName
)
ENABLE
;

GRANT ALL ON Events TO ROLE_HR_MIG;
...
alter session set current_schema=CourseWork;
set define off
CREATE OR REPLACE FUNCTION CourseWork.fn_diagramobjects
RETURN NUMBER
AUTHID DEFINER
AS
...
END;
/
GRANT ALL ON fn_diagramobjects TO ROLE_HR_MIG;
CREATE OR REPLACE PROCEDURE CourseWork.LogInToSystem
(
  v_Login IN NVARCHAR2,
  v_Password_in IN NVARCHAR2,
  v_PersonID OUT NUMBER
)
AS
   v_RoleID NUMBER(10,0) := 0;
   v_Correct_Password NVARCHAR2(30);
   v_BlockEndDate DATE;
   v_Block_count NUMBER(10,0);
   v_SearchPersonID NUMBER(10,0);
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               SELECT EndDate 
                 ...
                 FROM UserBlocks 
                WHERE  UserID = v_SearchPersonID;
               IF v_BlockEndDate < SYSDATE THEN
         ...
         BEGIN
            ...
            SELECT COUNT(*)  
              ...
              INTO v_Block_count
              FROM OrganizerBlocks 
             WHERE  OrganizerID = v_SearchPersonID;
            IF ( v_Block_count > 0 ) THEN
...
END;
/
GRANT ALL ON LogInToSystem TO ROLE_HR_MIG;
CREATE OR REPLACE PROCEDURE Registration
(
  v_Login_in IN NVARCHAR2,
  v_Password_in IN NVARCHAR2,
  v_FirstName_in IN NVARCHAR2,
  v_LastName_in IN NVARCHAR2,
  v_Email_in IN NVARCHAR2,
  v_Phone_in IN NVARCHAR2,
  v_RoleSwitch IN NUMBER
)
AS
   v_maxID NUMBER(10,0);
   v_login_exists NUMBER(10,0);
   v_phone_exists NUMBER(10,0);
   v_email_exists NUMBER(10,0);
   v_minID NUMBER(10,0) := 999;
...
BEGIN
   ...
   SELECT MAX(MAX_ID)  + 1 
     ...
     INTO v_maxID
     FROM ( SELECT NVL(MAX(UserID) , v_minID) MAX_ID  
            FROM Users 
            UNION ALL 
            SELECT NVL(MAX(OrganizerID) , v_minID) MAX_ID  
            FROM Organizers 
            UNION ALL 
            SELECT NVL(MAX(ManagerID) , v_minID) MAX_ID  
            FROM Managers  ) AllIDs;
   SELECT ( SELECT COUNT(*)  
            FROM ( SELECT 1 Match  
                   FROM Users 
                    WHERE  LOGIN = v_Login_in
                   UNION ALL 
                   SELECT 1 Match  
                   FROM Organizers 
                    WHERE  CompanyName = v_Login_in
                   UNION ALL 
                   SELECT 1 Match  
                   FROM Managers 
                    WHERE  LOGIN = v_Login_in ) LoginMatches ) 
   ...
   SELECT ( SELECT COUNT(*)  
            FROM ( SELECT 1 Match  
                   ...
                   SELECT 1 Match  
                   FROM Managers 
                    WHERE  Phone = v_Phone_in ) PhoneMatches ) 
   ...
   SELECT ( SELECT COUNT(*)  
            FROM ( SELECT 1 Match  
                   ...
                   SELECT 1 Match  
                   FROM Managers 
                    WHERE  Email = v_Email_in ) EmailMatches ) 

     INTO v_email_exists
     FROM DUAL ;
   IF v_login_exists = 0
     AND v_phone_exists = 0
     AND v_email_exists = 0 THEN
    
   BEGIN
      IF v_RoleSwitch = 0 THEN
       
      BEGIN
         INSERT INTO Users
           ( UserID, LOGIN, PASSWORD, FirstName, LastName, Email, Phone, RoleID )
           VALUES ( v_maxID, v_Login_in, v_Password_in, v_FirstName_in, v_LastName_in, v_Email_in, v_Phone_in, 1 );
      
      END;
      END IF;
      IF v_RoleSwitch = 1 THEN
       
      BEGIN
         INSERT INTO CheckingOrganizers
           ( OrganizerID, CompanyName, PASSWORD, FirstName, LastName, Email, Phone, RoleID )
           VALUES ( v_maxID, v_Login_in, v_Password_in, v_FirstName_in, v_LastName_in, v_Email_in, v_Phone_in, 2 );
...
END;
/
GRANT ALL ON Registration TO ROLE_HR_MIG;
CREATE OR REPLACE FUNCTION CourseWork.sp_alterdiagram
(
...
END;
/
GRANT ALL ON sp_alterdiagram TO ROLE_HR_MIG;
CREATE OR REPLACE FUNCTION CourseWork.sp_creatediagram
(
  v_diagramname IN VARCHAR2,
  iv_owner_id IN NUMBER DEFAULT NULL ,
  v_version IN NUMBER,
...
BEGIN
   ...
   END;
   END IF;
   INSERT INTO CourseWork.sysdiagrams
...
END;
/
GRANT ALL ON sp_creatediagram TO ROLE_HR_MIG;
CREATE OR REPLACE FUNCTION CourseWork.sp_dropdiagram
(
  v_diagramname IN VARCHAR2,
  iv_owner_id IN NUMBER DEFAULT NULL 
)
...
END;
/
GRANT ALL ON sp_dropdiagram TO ROLE_HR_MIG;
CREATE OR REPLACE FUNCTION CourseWork.sp_helpdiagramdefinition
(
  v_diagramname IN VARCHAR2,
  iv_owner_id IN NUMBER DEFAULT NULL 
)
...
END;
/
GRANT ALL ON sp_helpdiagramdefinition TO ROLE_HR_MIG;
CREATE OR REPLACE PROCEDURE CourseWork.sp_helpdiagrams
(
...
END;
/
GRANT ALL ON sp_helpdiagrams TO ROLE_HR_MIG;
CREATE OR REPLACE FUNCTION CourseWork.sp_renamediagram
(
  v_diagramname IN VARCHAR2,
  iv_owner_id IN NUMBER DEFAULT NULL ,
...
END;
/
GRANT ALL ON sp_renamediagram TO ROLE_HR_MIG;
/* Translation Extracted DDL For Required Objects*/
CREATE TABLE CourseWork.sysdiagrams
(
...
/
CREATE SEQUENCE tt_CourseWork.sysdiagrams_d 
;
/
CREATE OR REPLACE TRIGGER 
 tt_TR_rseWork.sysdiagrams_d    BEFORE INSERT 
   ON CourseWork.sysdiagrams
   FOR EACH ROW
   BEGIN
      SELECT tt_CourseWork.sysdiagrams_d.NEXTVAL INTO :NEW.diagram_id
        FROM DUAL;
   END;
/


CREATE OR REPLACE FUNCTION CourseWork.sp_upgraddiagrams
RETURN NUMBER
AS
...
BEGIN
   ...
   IF utils.object_id(N'dbo.sysdiagrams') IS NOT NULL THEN
    RETURN 0;
   END IF;
   DELETE FROM CourseWork.sysdiagrams;
   ...
   BEGIN
      INSERT INTO CourseWork.sysdiagrams
        ...
        ( SELECT UTILS.CONVERT_TO_VARCHAR2(dgnm.uvalue,128) ,
                 ...
                 dgdef.lvalue 
          FROM CourseWork.dtproperties dgnm
                 JOIN CourseWork.dtproperties dggd   ON dggd.property = 'DtgSchemaGUID'
                 AND dggd.objectid = dgnm.objectid
                 JOIN CourseWork.dtproperties dgdef   ON dgdef.property = 'DtgSchemaDATA'
...
END;
/
GRANT ALL ON sp_upgraddiagrams TO ROLE_HR_MIG;
set define on
prompt connecting to CourseWork
alter session set current_schema=CourseWork;
set define off
PROMPT Creating Foreign Key Constraint fk_UserOfTicketRefund on table Users...
ALTER TABLE TicketRefund
ADD CONSTRAINT fk_UserOfTicketRefund FOREIGN KEY
(
  UserID
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint fk_UserOfSale on table Users...
ALTER TABLE Sales
ADD CONSTRAINT fk_UserOfSale FOREIGN KEY
(
  UserID
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint fk_ManagerQuestion_User on table Managers...
ALTER TABLE UserQuestions
ADD CONSTRAINT fk_ManagerQuestion_User FOREIGN KEY
(
  ManagerID
)
REFERENCES Managers
...
PROMPT Creating Foreign Key Constraint fk_TicketShoppingCart on table Tickets...
ALTER TABLE ShoppingCart
ADD CONSTRAINT fk_TicketShoppingCart FOREIGN KEY
(
  TicketID
)
REFERENCES Tickets
...
PROMPT Creating Foreign Key Constraint fk_EventsScheduleEvents on table Events...
ALTER TABLE EventsSchedule
ADD CONSTRAINT fk_EventsScheduleEvents FOREIGN KEY
(
  EventID
)
REFERENCES Events
...
PROMPT Creating Foreign Key Constraint fk_RoleUser on table Roles...
ALTER TABLE Users
ADD CONSTRAINT fk_RoleUser FOREIGN KEY
(
  RoleID
)
REFERENCES Roles
...
PROMPT Creating Foreign Key Constraint fk_OrganizerQuestion on table Organizers...
ALTER TABLE OrganizerQuestions
ADD CONSTRAINT fk_OrganizerQuestion FOREIGN KEY
(
  OrganizerID
)
...
PROMPT Creating Foreign Key Constraint fk_LocationForEvents on table Locations...
ALTER TABLE EventsSchedule
ADD CONSTRAINT fk_LocationForEvents FOREIGN KEY
(
  LocationID
)
...
PROMPT Creating Foreign Key Constraint fk_CommentEvent on table Events...
ALTER TABLE Comments
ADD CONSTRAINT fk_CommentEvent FOREIGN KEY
(
  EventID
)
REFERENCES Events
...
PROMPT Creating Foreign Key Constraint fk_UserQuestion on table Users...
ALTER TABLE UserQuestions
ADD CONSTRAINT fk_UserQuestion FOREIGN KEY
(
  UserID
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint fk_Location on table Locations...
ALTER TABLE SectorRows
ADD CONSTRAINT fk_Location FOREIGN KEY
(
  LocationID
)
REFERENCES Locations
...
PROMPT Creating Foreign Key Constraint fk_SaleOfTicketRefund on table Sales...
ALTER TABLE TicketRefund
ADD CONSTRAINT fk_SaleOfTicketRefund FOREIGN KEY
(
  SaleID
)
REFERENCES Sales
...
PROMPT Creating Foreign Key Constraint fk_RoleOrganizer on table Roles...
ALTER TABLE Organizers
ADD CONSTRAINT fk_RoleOrganizer FOREIGN KEY
(
  RoleID
)
REFERENCES Roles
...
PROMPT Creating Foreign Key Constraint fk_TicketOfSale on table Tickets...
ALTER TABLE Sales
ADD CONSTRAINT fk_TicketOfSale FOREIGN KEY
(
  TicketID
)
REFERENCES Tickets
...
PROMPT Creating Foreign Key Constraint fk_CategoryForEvents on table Categories...
ALTER TABLE Events
ADD CONSTRAINT fk_CategoryForEvents FOREIGN KEY
(
  CategoryID
)
...
PROMPT Creating Foreign Key Constraint fk_CommentUser on table Users...
ALTER TABLE Comments
ADD CONSTRAINT fk_CommentUser FOREIGN KEY
(
  UserID
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint fk_UserShoppingCart on table Users...
ALTER TABLE ShoppingCart
ADD CONSTRAINT fk_UserShoppingCart FOREIGN KEY
(
  UserID
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint fk_OrganizerForEvents on table Organizers...
ALTER TABLE Events
ADD CONSTRAINT fk_OrganizerForEvents FOREIGN KEY
(
  OrganizerID
)
REFERENCES Organizers
...
PROMPT Creating Foreign Key Constraint fk_RoleManager on table Roles...
ALTER TABLE Managers
ADD CONSTRAINT fk_RoleManager FOREIGN KEY
(
  RoleID
)
REFERENCES Roles
...
PROMPT Creating Foreign Key Constraint fk_ManagerQuestion_Organizer on table Managers...
ALTER TABLE OrganizerQuestions
ADD CONSTRAINT fk_ManagerQuestion_Organizer FOREIGN KEY
(
  ManagerID
)
REFERENCES Managers
...
GRANT ALL ON clobtoblob_sqldeveloper TO ROLE_HR_MIG;
spool off;
